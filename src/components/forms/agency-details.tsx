  ...
  const handleSubmit = async (values: z.infer<typeof schema>) => {
    try {
      ...
      if (!data?.id) {
        ...
        newUserData = await initUser({ role: PLURA_ROLE.AGENCY_OWNER });
        if (!data?.id) {
                  ...
                  <NumberInput
                    ...
                    onValueChange={async (value) => {
                      ...
                      await saveActivityLogsNotification({
                        agencyId: data.id,
                        description: `Updated agency goal to ${value} Sub Account`,
          ...
          {data?.id && (
            <>
              ...
              <AlertDialogTrigger
                ...
                className="text-red-600 text-center mt-2 rounded-md hover:bg-red-600 hover:text-white whitespace-nowrap"
              >
